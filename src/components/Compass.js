    ...
    return (
      <section>
        <div className="grid_wrapper">
          {this.state.grid}
          {this._createPeople()}
          <div className="grid_label grid_label_left">Liberal</div>
          <div className="grid_label grid_label_right">Conservative</div>
          <div className="grid_label grid_label_top">Authoritarian</div>
          <div className="grid_label grid_label_bottom">Libertarian</div>
        </div>
      </section>
    );
  }
